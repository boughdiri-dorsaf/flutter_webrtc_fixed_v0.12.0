...
--------------------------------------------
[0.12.0] - 2024-10-16 (Fixed Version)

* This is a fixed and improved version of flutter_webrtc v0.12.0
* Package renamed to flutter_webrtc_fixed_v0.12.0 for pub.dev publishing
* Repository moved to https://github.com/boughdiri-dorsaf/flutter_webrtc_fixed_v0.12.0
* All original features and bug fixes from the original package are preserved
* Additional improvements and optimizations for production use

[0.12.0] - 2024-10-16 (Original)
